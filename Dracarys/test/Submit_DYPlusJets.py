...
ListOfSamples=[#'/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext1-v2/MINIAODSIM',
...
for i in ListOfSamples:
    ...
    cmd.getoutput('sed -i -- "s/OUTPUTDIR/DYJetsToLL_HT/g" '+WorkingFolder+'/Crab_'+UsefulString+'.py')

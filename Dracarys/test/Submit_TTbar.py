...
ListOfSamples=['/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM']
...
for i in ListOfSamples:
    ...
    cmd.getoutput('sed -i -- "s/OUTPUTDIR/TTToLL_MLL/g" '+WorkingFolder+'/Crab_'+UsefulString+'.py')
